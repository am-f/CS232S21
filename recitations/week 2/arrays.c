/*
Copy the following program that contains an example of two different functions with array parameters: array parameters example.

Try compiling and running it to understand what it is doing.

Then complete the implementation of the minimum function and test it out.
*/
